...
affecting compatibility for clients, could affect compatibility for *porters* of
the library. For such changes we make announcements to [libphonenumber-discuss]
