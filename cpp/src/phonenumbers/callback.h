...
class ResultCallback4 {
 public:
  virtual ~ResultCallback4() = default;
...
class FunctionCallback4 : public ResultCallback4<R, A1, A2, A3, A4> {
 public:
  ...
  virtual ~FunctionCallback4() = default;
...
class ConstMethodCallback4 : public ResultCallback4<R, A1, A2, A3, A4> {
 public:
  ...
  virtual ~ConstMethodCallback4() = default;
...
template <typename R, typename A1, typename A2, typename A3, typename A4>
ResultCallback4<R, A1, A2, A3, A4>* NewPermanentCallback(R (*function)(A1, A2,
                                                                       A3,
                                                                       A4)) {
...
ResultCallback4<R, A1, A2, A3, A4>* NewPermanentCallback(
    const T* instance, R (T::*method)(A1, A2, A3, A4) const) {
