...
,[,,"(?:3(?:[23469]\\d|77|8[348])\\d|6(?:1[16]\\d|6(?:[06]\\d3[03-9]|44|)|9(?:69|9[6-9]))|77\\d{2})\\d{4}","\\d{8}",,,"36001234"]
,[,,"80\\d{6}","\\d{8}",,,"80123456"]
...
,"SX":[,[,,"[5789]\\d{9}","\\d{7}(?:\\d{3})?"]
,[,,"72154[2-8]\\d{4}","\\d{7}(?:\\d{3})?",,,"7215425678"]
,[,,"7215(?:1[02]|2\\d|5[0346]|8[01678])\\d{4}","\\d{10}",,,"7215205678"]
,[,,"8(?:00|55|66|77|88)[2-9]\\d{6}","\\d{10}",,,"8002123456"]
,[,,"900[2-9]\\d{6}","\\d{10}",,,"9002123456"]
,[,,"NA","NA"]
,[,,"5(?:00|33|44)[2-9]\\d{6}","\\d{10}",,,"5002345678"]
...
,"UG":[,[,,"\\d{9}","\\d{5,9}"]
,[,,"20(?:[014]\\d{2}|2(?:40|[5-9]\\d)|3[23]|4\\d)\\d{4}|[34]\\d{8}","\\d{5,9}",,,"312345678"]
,[,,"7(?:0[0-7]|[15789]\\d)\\d{6}","\\d{9}",,,"712345678"]
