...
,"AR":[,[,,"[1-3689]\\d{9,10}","\\d{6,11}",,,,,,[6,7,8,9,10,11]
]
,[,,"[1-3]\\d{9}","\\d{6,10}",,,,,,[6,7,8,9,10]
]
,[,,"9\\d{10}|[1-3]\\d{9}","\\d{10,11}",,,,,,[10,11]
]
,[,,"80\\d{8}","\\d{10}",,,,,,[10]
]
,[,,"6(0\\d|10)\\d{7}","\\d{10}",,,,,,[10]
]
,[,,"NA","NA",,,,,,[-1]
]
,[,,"NA","NA",,,,,,[-1]
...
,"BS":[,[,,"(242|8(00|66|77|88)|900)\\d{7}","\\d{7,10}",,,,,,[10]
,[7]
]
...
,"CN":[,[,,"[1-7]\\d{6,11}|8[0-357-9]\\d{6,9}|9\\d{7,10}","\\d{4,12}",,,,,,[11]
]
...
,"DE":[,[,,"\\d{4,14}","\\d{2,14}",,,,,,[4,5,6,7,8,9,10,11]
,[2,3]
]
,[,,"(?:[24-6]\\d{2}|3[03-9]\\d|[789](?:0[2-9]|[1-9]\\d))\\d{1,8}","\\d{2,14}",,,"30123456"]
,[,,"1(5\\d{9}|7\\d{8}|6[02]\\d{8}|63\\d{7})","\\d{10,11}",,,,,,[10,11]
]
,[,,"800\\d{7}","\\d{10}",,,,,,[10]
]
,[,,"900([135]\\d{6}|9\\d{7})","\\d{10,11}",,,,,,[10,11]
]
,[,,"NA","NA",,,,,,[-1]
]
,[,,"NA","NA",,,,,,[-1]
...
,[,,"[1-6]\\d{9}","\\d{6,10}"]
,[,,"7[1-57-9]\\d{8}","\\d{10}",,,,,,[10]
]
,[,,"80\\d{8}","\\d{10}",,,,,,[10]
]
,[,,"9[018]\\d{8}","\\d{10}",,,,,,[10]
]
,[,,"8(?:4[3-5]|7[0-2])\\d{7}","\\d{10}",,,,,,[10]
]
,[,,"70\\d{8}","\\d{10}",,,,,,[10]
]
,[,,"56\\d{8}","\\d{10}",,,,,,[10]
...
,"IT":[,[,,"[0389]\\d{5,10}","\\d{6,11}",,,,,,[6,9,10,11]
]
,[,,"0\\d{9,10}","\\d{10,11}",,,,,,[10,11]
]
,[,,"3\\d{8,9}","\\d{9,10}",,,,,,[9,10]
]
,[,,"80(?:0\\d{6}|3\\d{3})","\\d{6,9}",,,,,,[6,9]
]
,[,,"89(?:2\\d{3}|9\\d{6})","\\d{6,9}",,,,,,[6,9]
]
,[,,"NA","NA",,,,,,[-1]
]
,[,,"NA","NA",,,,,,[-1]
...
,"JP":[,[,,"07\\d{5}|[1-357-9]\\d{3,10}","\\d{4,11}",,,,,,[4,5,6,7,8,9,10,11]
]
,[,,"07\\d{5}|[1-357-9]\\d{3,10}","\\d{4,11}"]
,[,,"07\\d{5}|[1-357-9]\\d{3,10}","\\d{4,11}",,,,,,[4,5,6,7,8,9,10,11]
]
,[,,"0777[01]\\d{2}","\\d{7}",,,"0777012",,,[7]
]
,[,,"NA","NA",,,,,,[-1]
]
,[,,"NA","NA",,,,,,[-1]
...
,"KR":[,[,,"[1-7]\\d{3,9}|8\\d{8}","\\d{4,10}",,,,,,[4,5,6,7,8,9,10]
]
,[,,"(?:2|[34][1-3]|5[1-5]|6[1-4])(?:1\\d{2,3}|[2-9]\\d{6,7})","\\d{4,10}",,,"22123456"]
,[,,"1[0-25-9]\\d{7,8}","\\d{9,10}",,,"1023456789",,,[9,10]
]
...
,"NZ":[,[,,"[289]\\d{7,9}|[3-7]\\d{7}","\\d{7,10}",,,,,,[7,8,9,10]
]
,[,,"24099\\d{3}|(?:3[2-79]|[479][2-689]|6[235-9])\\d{6}","\\d{7,8}",,,,,,[7,8]
]
,[,,"2(?:[027]\\d{7}|9\\d{6,7}|1(?:0\\d{5,7}|[12]\\d{5,6}|[3-9]\\d{5})|4[1-9]\\d{6}|8\\d{7,8})","\\d{8,10}",,,,,,[8,9,10]
]
,[,,"800\\d{6,7}","\\d{9,10}",,,,,,[9,10]
]
,[,,"900\\d{6,7}","\\d{9,10}",,,,,,[9,10]
]
,[,,"NA","NA",,,,,,[-1]
]
,[,,"NA","NA",,,,,,[-1]
...
,"SG":[,[,,"[13689]\\d{7,10}","\\d{8}|\\d{10,11}",,,,,,[8,10,11]
]
,[,,"[36]\\d{7}","\\d{8}",,,,,,[8]
]
,[,,"[89]\\d{7}","\\d{8}",,,,,,[8]
...
,"US":[,[,,"[13-689]\\d{9}|2[0-35-9]\\d{8}","\\d{7}(?:\\d{3})?",,,"1234567890",,,[10]
,[7]
]
,[,,"[13-689]\\d{9}|2[0-35-9]\\d{8}","\\d{7}(?:\\d{3})?",,,"1234567890"]
,[,,"[13-689]\\d{9}|2[0-35-9]\\d{8}","\\d{7}(?:\\d{3})?",,,"1234567890",,,[10]
,[7]
]
