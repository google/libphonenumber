...
,[,,"6(?:[0156]\\d|[28][0-5]|4[01])\\d{5}|7\\d{7}","\\d{8}"]
,[,,"NA","NA"]
,[,,"NA","NA"]
,[,,"NA","NA"]
,[,,"NA","NA"]
...
,[,,"(?:3(?:[23469]\\d|5[035]|77|8[348])\\d|6(?:1[16]\\d|3(?:00|33|6[16])|6(?:[069]\\d|3[03-9]|44)|9(?:69|9[6-9]))|77\\d{2})\\d{4}","\\d{8}"]
,[,,"80\\d{6}","\\d{8}"]
,[,,"(?:87|9[014578])\\d{6}","\\d{8}"]
,[,,"84\\d{6}","\\d{8}"]
,[,,"NA","NA"]
...
,[,,"1(?:1(?:5[347]|[6-9]\\d|)|[2-9][6-9]\\d)\\d{6}|(?:2[12478]|3[1-578]|[4689][1-9]|5[13-5]|7[13-579])[6-9]\\d{7}|(?:119\\d|1[2-9]9[6-9])\\d{7}","\\d{10,11}"]
,[,,"800\\d{6,7}","\\d{8,11}"]
,[,,"[359]00\\d{6,7}","\\d{8,11}"]
,[,,"[34]00\\d{5}","\\d{8}"]
,[,,"NA","NA"]
...
,[,,"NA","NA"]
,[,,"NA","NA"]
,[,,"210[0-6]\\d{4}|4(?:0(?:[04]0\\d{4}|10[0-3]\\d{3}|2(?:00\\d|900)\\d{2}|3[01]\\d{4}|5\\d{5}|70[01]\\d{3})|1[01]\\d{5}|20[0-3]\\d{4}|400\\d{4}|70[0-2]\\d{4})|5100\\d{4}","\\d{8}"]
...
,"EH":[,[,,"[5689]\\d{8}","\\d{9}"]
,[,,"528[89]\\d{5}","\\d{9}"]
,[,,"6(?:0[0-8]|[14-7]\\d|2[0-46-9]|3[03-8]|8[01]|99)\\d{6}","\\d{9}"]
,[,,"80\\d{7}","\\d{9}"]
,[,,"89\\d{7}","\\d{9}"]
,[,,"NA","NA"]
,[,,"NA","NA"]
...
,[,,"(?:[145](?:1[1-9]|[2-9]\\d)\\d{0,3}|[23][1-9]\\d{0,4}|6[1-9]\\d{1,4}|[78]\\d{2,5})\\d{4}","\\d{6,10}"]
,[,,"9[1-3]\\d{8}","\\d{10}"]
,[,,"NA","NA"]
,[,,"NA","NA"]
,[,,"NA","NA"]
...
,[,,"(?:(?:1\\d|6[016-9]|7(?:[07-9]|6\\d))[1-9]|8(?:0[89]|[134679]\\d|5[2-9]|8\\d{2})|9(?:[0-589][1-9]|[67][1-9]\\d?))\\d{5}","\\d{8,9}"]
...
,[,,"7(?:0[01257]|6[02-4]|7[15-8]|85)\\d{7}","\\d{10}"]
,[,,"800\\d{7}","\\d{10}"]
,[,,"809\\d{7}","\\d{10}"]
,[,,"NA","NA"]
,[,,"NA","NA"]
