...
,[,,"6(?:[0-24-6]\\d|8[0-5]|3[0-3]|)\\d{5}|7\\d{7}","\\d{8}"]
,[,,"NA","NA"]
,[,,"NA","NA"]
,[,,"NA","NA"]
,[,,"NA","NA"]
...
,[,,"NA","NA"]
,[,,"NA","NA"]
,[,,"210[0-6]\\d{4}|4(?:0(?:[04]0\\d{4}|10[0-3]\\d{3}|2(?:00\\d|900)\\d{2}|3[01]\\d{4}|5\\d{5}|70[01]\\d{3}|8[0-2]\\d{4})|1[01]\\d{5}|20[0-3]\\d{4}|400\\d{4}|70[0-2]\\d{4})|5100\\d{4}","\\d{8}"]
...
,[,,"5(?:2[59]\\d|4(?:2[1-389]|4\\d|7[1-9]|9\\d)|7\\d{2}|8(?:[26]\\d|7[15-8])|9[0-8]\\d)\\d{4}","\\d{8}"]
,[,,"80[012]\\d{4}","\\d{7}"]
,[,,"30\\d{5}","\\d{7}"]
,[,,"NA","NA"]
,[,,"NA","NA"]
