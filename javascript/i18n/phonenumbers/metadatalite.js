...
,[,,"2(?:2\\d{7}|1962\\d{4})|(?:3[2-5]|[47][1-35]|5[1-3578]|6[1347])\\d{7}|65\\d{6,7}","\\d{6,9}"]
,[,,"9[5-9]\\d{7}","\\d{8,9}"]
...
,[,,"(?:[237]\\d{2}|411|89\\d{3})\\d{3}","\\d{6}(?:\\d{2})?"]
,[,,"NA","NA"]
,[,,"NA","NA"]
,[,,"NA","NA"]
,[,,"NA","NA"]
