...
,[,,"(?:3(?:[23469]\\d|5[35]|77|8[348])\\d|6(?:1[16]\\d|3(?:00|33|6[16])|6(?:[069]\\d|3[03-9]|44)|9(?:69|9[6-9]))|77\\d{2})\\d{4}","\\d{8}"]
,[,,"80\\d{6}","\\d{8}"]
,[,,"(?:87|9[014578])\\d{6}","\\d{8}"]
,[,,"84\\d{6}","\\d{8}"]
,[,,"NA","NA"]
...
,[,,"6(?:0[0-6]|[14-7]\\d|2[02-46-9]|3[03-8]|8[01]|99)\\d{6}","\\d{9}"]
,[,,"80\\d{7}","\\d{9}"]
,[,,"89\\d{7}","\\d{9}"]
,[,,"NA","NA"]
,[,,"NA","NA"]
