...
,[,,"6(?:[0-24-68]\\d|3[0-7]|70)\\d{5}|7\\d{7}","\\d{8}"]
,[,,"NA","NA"]
,[,,"NA","NA"]
,[,,"NA","NA"]
,[,,"NA","NA"]
...
,[,,"7(?:[1-35]\\d{6}|[46][0-7]\\d{5}|7[0146]\\d{5})","\\d{8}"]
,[,,"NA","NA"]
,[,,"90\\d{5}","\\d{7}"]
,[,,"NA","NA"]
,[,,"NA","NA"]
...
,[[,"(2)(\\d{3,4})(\\d{4})","$1 $2 $3",["2","2"]
,"($1)","$CC ($1)",0]
,[,"(\\d{2})(\\d{2,3})(\\d{4})","$1 $2 $3",["[357]|4[1-35]|6[13-57]","[357]|4[1-35]|6[13-57]"]
,"($1)","$CC ($1)",0]
...
,[,,"2[24-7]\\d{6}","\\d{8}"]
,[,,"5(?:0[0-4]|7[01])\\d{5}|6(?:[0-2]\\d|30)\\d{5}|7[0-2]\\d{6}|8[3-9]\\d{6}","\\d{8}"]
,[,,"800\\d{7}","\\d{10}"]
,[,,"90[059]\\d{7}","\\d{10}"]
,[,,"NA","NA"]
,[,,"NA","NA"]
...
,[,,"(?:5[4-6]|7[7-9])\\d{7}|6(?:[569]\\d|70)\\d{6}","\\d{9}"]
,[,,"800\\d{6}","\\d{9}"]
,[,,"80[3-689]1\\d{5}","\\d{9}"]
,[,,"80[12]1\\d{5}","\\d{9}"]
,[,,"NA","NA"]
...
,[,,"(?:562|6(?:50|7[1-6]|[089]\\d)|7(?:67|7[47-9]|[89]\\d))\\d{5}","\\d{8}"]
,[,,"800\\d{5}","\\d{8}"]
,[,,"90[056]\\d{5}","\\d{8}"]
,[,,"808\\d{5}","\\d{8}"]
,[,,"NA","NA"]
...
,"0$1","",0]
,[,"(\\d{3})(\\d{3})(\\d{3,4})","$1 $2 $3",["70|8[01]|909"]
,"0$1","",0]
...
,[,,"3(?:0\\d|1[1-5]|2[0-5]|[34][1-7]|55|64)\\d{7}","\\d{10}"]
,[,,"800\\d{5}","\\d{8}"]
,[,,"900\\d{5}","\\d{8}"]
,[,,"NA","NA"]
,[,,"122\\d{6}","\\d{9}"]
