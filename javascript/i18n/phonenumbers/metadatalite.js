...
,[,,"4(?:0[45689]\\d|4|99\\d)\\d{4}","\\d{6}(?:\\d{2})?"]
,[,,"8[79]\\d{6}","\\d{8}"]
,[,,"NA","NA"]
,[,,"NA","NA"]
,[,,"NA","NA"]
...
,[,,"48\\d{3}|7(?:[0146-8]\\d|5[025-9]|90)\\d{4}|8[4-8]\\d{5}|9(?:[46]\\d|5[0-46-9]|7[0-689]|8[0-79]|9[0-8])\\d{4}","\\d{5,7}"]
,[,,"1[38]\\d{3}","\\d{5}"]
,[,,"NA","NA"]
,[,,"NA","NA"]
,[,,"NA","NA"]
