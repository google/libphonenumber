...
public class AsYouTypeFormatter {
  ...
  private static final PhoneMetadata EMPTY_METADATA = GenerateEmptyMetadata();
  ...
  private static PhoneMetadata GenerateEmptyMetadata() {
    PhoneMetadata emptyMetadata = new PhoneMetadata();
    emptyMetadata.internationalPrefix = "NA";
