...
/**
 ...
 <p> <code>key</code> could be the calling country code and the full significant number of a certain number, or it could be just a phone-number prefix. For example, the full number 16502530000 (from the phone-number +1 650 253 0000) is a valid input. Also, any of its prefixes, such as 16502, is also valid.
...
static NSString *ComGoogleI18nPhonenumbersPrefixmapperPrefixTimeZonesMap_RAW_STRING_TIMEZONES_SEPARATOR_ = @"&";
J2OBJC_STATIC_FIELD_GETTER(ComGoogleI18nPhonenumbersPrefixmapperPrefixTimeZonesMap, RAW_STRING_TIMEZONES_SEPARATOR_, NSString *)
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "readPrefixTimeZonesMapWithJavaUtilSortedMap:", "readPrefixTimeZonesMap", "V", 0x1, NULL, NULL },
    ...
    { "lookupTimeZonesForNumberWithLong:", "lookupTimeZonesForNumber", "Ljava.util.List;", 0x2, NULL, NULL },
    { "lookupTimeZonesForNumberWithComGoogleI18nPhonenumbersPhonenumber_PhoneNumber:", "lookupTimeZonesForNumber", "Ljava.util.List;", 0x1, NULL, NULL },
    { "lookupCountryLevelTimeZonesForNumberWithComGoogleI18nPhonenumbersPhonenumber_PhoneNumber:", "lookupCountryLevelTimeZonesForNumber", "Ljava.util.List;", 0x1, NULL, NULL },
    { "tokenizeRawOutputStringWithNSString:", "tokenizeRawOutputString", "Ljava.util.List;", 0x2, NULL, NULL },
    { "description", "toString", "Ljava.lang.String;", 0x1, NULL, NULL },
    { "init", NULL, NULL, 0x1, NULL, NULL },
  };
  static const J2ObjcFieldInfo fields[] = {
    { "phonePrefixMap_", NULL, 0x12, "Lcom.google.i18n.phonenumbers.prefixmapper.PhonePrefixMap;", NULL, NULL,  },
    { "RAW_STRING_TIMEZONES_SEPARATOR_", NULL, 0x1a, "Ljava.lang.String;", &ComGoogleI18nPhonenumbersPrefixmapperPrefixTimeZonesMap_RAW_STRING_TIMEZONES_SEPARATOR_, NULL,  },
  };
...
id<JavaUtilList> ComGoogleI18nPhonenumbersPrefixmapperPrefixTimeZonesMap_tokenizeRawOutputStringWithNSString_(ComGoogleI18nPhonenumbersPrefixmapperPrefixTimeZonesMap *self, NSString *timezonesString) {
  JavaUtilStringTokenizer *tokenizer = [new_JavaUtilStringTokenizer_initWithNSString_withNSString_(timezonesString, ComGoogleI18nPhonenumbersPrefixmapperPrefixTimeZonesMap_RAW_STRING_TIMEZONES_SEPARATOR_) autorelease];
...
void ComGoogleI18nPhonenumbersPrefixmapperPrefixTimeZonesMap_init(ComGoogleI18nPhonenumbersPrefixmapperPrefixTimeZonesMap *self) {
  NSObject_init(self);
  ComGoogleI18nPhonenumbersPrefixmapperPrefixTimeZonesMap_setAndConsume_phonePrefixMap_(self, new_ComGoogleI18nPhonenumbersPrefixmapperPhonePrefixMap_init());
}
